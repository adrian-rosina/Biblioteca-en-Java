...
public class Main {
    ...
    private static void cargarDatos() {
        ...
        catalogo.alta(new Videojuego(5,"World of War Craft", "2000", Formato.DIGITAL,"PC", 14));
        catalogo.alta(new Videojuego(6,"Call of Duty", "1999", Formato.FISICO,"Play Station", 17));
    ...
    private static void menu() {
        ...
        do {
            ...
            System.out.println("8. Crear usuario manualmente"); // NUEVO
            ...
            switch (op) {
                ...
                case 8 -> crearUsuarioManual(); // NUEVO
    ...
    private static void prestar() {
     ...
     //Sección de usuario
        ...
        //Creacion automatica si no existe
   ...
   //Creación manual de usuario
    ...
    private static void crearUsuarioManual() {
        ...
        usuarios.add(new Usuario(cod, nombre));
